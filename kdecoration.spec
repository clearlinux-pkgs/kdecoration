...
Source0  : https://download.kde.org/stable/plasma/6.0.5/kdecoration-6.0.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.5/kdecoration-6.0.5.tar.xz.sig
...
%setup -q -n kdecoration-6.0.5
cd %{_builddir}/kdecoration-6.0.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716391768
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkdecorations2.so.6.0.5
/V3/usr/lib64/libkdecorations2private.so.6.0.5
/usr/lib64/libkdecorations2.so.6
/usr/lib64/libkdecorations2.so.6.0.5
/usr/lib64/libkdecorations2private.so.11
/usr/lib64/libkdecorations2private.so.6.0.5
