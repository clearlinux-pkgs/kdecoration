...
Source0  : https://download.kde.org/stable/plasma/6.4.0/kdecoration-6.4.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.4.0/kdecoration-6.4.0.tar.xz.sig
...
%setup -q -n kdecoration-6.4.0
cd %{_builddir}/kdecoration-6.4.0
pushd ..
cp -a kdecoration-6.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750186150
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkdecorations3.so.6.4.0
/V3/usr/lib64/libkdecorations3private.so.6.4.0
/usr/lib64/libkdecorations3.so.6
/usr/lib64/libkdecorations3.so.6.4.0
/usr/lib64/libkdecorations3private.so.2
/usr/lib64/libkdecorations3private.so.6.4.0
