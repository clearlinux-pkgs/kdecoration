...
Version  : 5.22.0
Release  : 47
URL      : https://download.kde.org/stable/plasma/5.22.0/kdecoration-5.22.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.22.0/kdecoration-5.22.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.22.0/kdecoration-5.22.0.tar.xz.sig
...
%prep
%setup -q -n kdecoration-5.22.0
cd %{_builddir}/kdecoration-5.22.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1623288181
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdecoration-5.22.0/LICENSES/LGPL-2.1-only.txt %{buildroot}/usr/share/package-licenses/kdecoration/3c3d7573e137d48253731c975ecf90d74cfa9efe
cp %{_builddir}/kdecoration-5.22.0/LICENSES/LGPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/kdecoration/757b86330df80f81143d5916b3e92b4bcb1b1890
cp %{_builddir}/kdecoration-5.22.0/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/kdecoration/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/kdecoration-5.22.0/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/kdecoration/e458941548e0864907e654fa2e192844ae90fc32
pushd clr-build
%make_install
popd
...
/usr/lib64/libkdecorations2.so.5.22.0
/usr/lib64/libkdecorations2private.so.5.22.0
