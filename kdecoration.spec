...
Version  : 5.14.1
Release  : 5
URL      : https://github.com/KDE/kdecoration/archive/v5.14.1.tar.gz
Source0  : https://github.com/KDE/kdecoration/archive/v5.14.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1539701302
mkdir -p clr-build
pushd clr-build
%cmake ..
...
/usr/lib64/libkdecorations2.so.5.14.1
/usr/lib64/libkdecorations2private.so.5.14.1
