...
Version  : 5.18.4.1
Release  : 34
URL      : https://github.com/KDE/kdecoration/archive/v5.18.4.1/kdecoration-5.18.4.1.tar.gz
Source0  : https://github.com/KDE/kdecoration/archive/v5.18.4.1/kdecoration-5.18.4.1.tar.gz
...
%prep
%setup -q -n kdecoration-5.18.4.1
cd %{_builddir}/kdecoration-5.18.4.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585675380
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdecoration-5.18.4.1/COPYING.LIB %{buildroot}/usr/share/package-licenses/kdecoration/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
...
/usr/lib64/libkdecorations2.so.5.18.4
/usr/lib64/libkdecorations2private.so.5.18.4
