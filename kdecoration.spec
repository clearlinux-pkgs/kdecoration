...
Version  : 5.14.2
Release  : 6
URL      : https://github.com/KDE/kdecoration/archive/v5.14.2.tar.gz
Source0  : https://github.com/KDE/kdecoration/archive/v5.14.2.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1540461939
mkdir -p clr-build
pushd clr-build
%cmake ..
...
/usr/lib64/libkdecorations2.so.5.14.2
/usr/lib64/libkdecorations2private.so.5.14.2
