...
Source0  : https://download.kde.org/stable/plasma/6.3.1/kdecoration-6.3.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.1/kdecoration-6.3.1.tar.xz.sig
...
%setup -q -n kdecoration-6.3.1
cd %{_builddir}/kdecoration-6.3.1
pushd ..
cp -a kdecoration-6.3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739904136
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkdecorations3.so.6.3.1
/V3/usr/lib64/libkdecorations3private.so.6.3.1
/usr/lib64/libkdecorations3.so.6
/usr/lib64/libkdecorations3.so.6.3.1
/usr/lib64/libkdecorations3private.so.1
/usr/lib64/libkdecorations3private.so.6.3.1
