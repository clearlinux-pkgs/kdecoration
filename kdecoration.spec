...
Version  : 5.13.5
Release  : 3
URL      : https://github.com/KDE/kdecoration/archive/v5.13.5.tar.gz
Source0  : https://github.com/KDE/kdecoration/archive/v5.13.5.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1536092116
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/lib64/libkdecorations2.so.5.13.5
/usr/lib64/libkdecorations2private.so.5.13.5
