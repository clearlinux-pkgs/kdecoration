...
Source0  : https://download.kde.org/stable/plasma/5.25.4/kdecoration-5.25.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.25.4/kdecoration-5.25.4.tar.xz.sig
...
%prep
%setup -q -n kdecoration-5.25.4
cd %{_builddir}/kdecoration-5.25.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659712444
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libkdecorations2.so.5.25.4
/usr/lib64/libkdecorations2private.so.5.25.4
