...
Version  : 5.15.3
Release  : 14
URL      : https://github.com/KDE/kdecoration/archive/v5.15.3.tar.gz
Source0  : https://github.com/KDE/kdecoration/archive/v5.15.3.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1552401824
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libkdecorations2.so.5.15.3
/usr/lib64/libkdecorations2private.so.5.15.3
