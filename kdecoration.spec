...
Version  : 5.13.4
Release  : 2
URL      : https://github.com/KDE/kdecoration/archive/v5.13.4.tar.gz
Source0  : https://github.com/KDE/kdecoration/archive/v5.13.4.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1533055547
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/lib64/libkdecorations2.so.5.13.4
/usr/lib64/libkdecorations2private.so.5.13.4
