...
Version  : 5.27.10
Release  : 88
URL      : https://download.kde.org/stable/plasma/5.27.10/kdecoration-5.27.10.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.10/kdecoration-5.27.10.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.10/kdecoration-5.27.10.tar.xz.sig
...
%prep
%setup -q -n kdecoration-5.27.10
cd %{_builddir}/kdecoration-5.27.10
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702977365
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkdecorations2.so.5.27.10
/V3/usr/lib64/libkdecorations2private.so.5.27.10
/usr/lib64/libkdecorations2.so.5
/usr/lib64/libkdecorations2.so.5.27.10
/usr/lib64/libkdecorations2private.so.10
/usr/lib64/libkdecorations2private.so.5.27.10
