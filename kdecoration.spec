...
Version  : 5.15.1
Release  : 12
URL      : https://github.com/KDE/kdecoration/archive/v5.15.1.tar.gz
Source0  : https://github.com/KDE/kdecoration/archive/v5.15.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1550586942
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/lib64/libkdecorations2.so.5.15.1
/usr/lib64/libkdecorations2private.so.5.15.1
