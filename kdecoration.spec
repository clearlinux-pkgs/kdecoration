...
Version  : 5.26.2
Release  : 71
URL      : https://download.kde.org/stable/plasma/5.26.2/kdecoration-5.26.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.26.2/kdecoration-5.26.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.26.2/kdecoration-5.26.2.tar.xz.sig
...
%prep
%setup -q -n kdecoration-5.26.2
cd %{_builddir}/kdecoration-5.26.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667241921
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libkdecorations2.so.5.26.2
/usr/lib64/libkdecorations2private.so.5.26.2
