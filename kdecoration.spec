...
Version  : 5.27.0
Release  : 76
URL      : https://download.kde.org/stable/plasma/5.27.0/kdecoration-5.27.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.0/kdecoration-5.27.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.0/kdecoration-5.27.0.tar.xz.sig
...
%prep
%setup -q -n kdecoration-5.27.0
cd %{_builddir}/kdecoration-5.27.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676838468
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libkdecorations2.so.5.27.0
/usr/lib64/libkdecorations2private.so.10
/usr/lib64/libkdecorations2private.so.5.27.0
